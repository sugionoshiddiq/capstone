...
st.write("Tahukah kalian bahwa lembaga Transparency International mengestimasi korupsi telah menyebabkan kerugian finansial secara global sebanyak 5% GDP dunia atau 3.6 Triliun USD setiap tahunnya? Jika dibagikan secara merata ke seluruh orang di dunia (7.9 Miliar jiwa) maka setiap orang harus menanggung 456 USD atau sekitar 7 Juta Rupiah setiap tahunnya. Melalui kondisi ini maka pemberantasan korupsi harus menjadi agenda dunia untuk mencegah kerugian yang lebih besar.")
...
fig = px.scatter(df2, x="T-Index", y="CPI 2021",hover_name='Negara', trendline="ols",title="Terdapat Hubungan Moderat Antara Indeks Transparansi dengan CPI di Tahun 2021")
...
st.write("Hubungan antara indeks pengembangan E-Government/EGDI dengan skor CPI di setiap tahun menyatakan bahwa ada hubungan positif diantara keduanya. Hal ini menunjukkan bahwa negara yang mengembangkan e-government dengan baik memiliki tingkat korupsi yang rendah.")
...
fig5 = px.scatter(df3, title="Hubungan E-Participation Dengan EGDI Semakin Membentuk Garis Lurus Sejak Tahun 2014", x="E-Participation", y="EGDI", color="CPI", animation_frame="Tahun", hover_name='Negara', size_max=20)
